...
Споживаймо відповідально. Дякую!""",  # noqa
    },
    "apolitical": {
...
Тому політика - це важливо. Брати в ній участь і впливати на суспільні процеси - теж важливо. Писати листи, запити, вимагати дотримання своїх прав і свобод. Джерелом влади в Україні є народ. Суспільний запит визначає курс держави. І починається з окремих людей та простих дій.""",  # noqa
    },
    "svc": {
...
Тобто, робиш грі вміст, рекламу і прибуток навіть не вносячи грошей напряму. І, тим самим, спонсоруєш ті ракети які потім летять по українських містах.""",  # noqa
    },
    "ukrainian_enhanced_kb_layout": {
        "title": "Розширена українська розкладка клавіатури",
...
https://oleksiyrudenko.github.io/Ukrainian-Enhanced-Keyboard-WIndows/""",  # noqa
    },
    "verify": {
        "title": "Верифікація",
        "description": """Верифікація, якщо увімкнена, працює наступним чином:
* Доступ до голосових каналів та деяких інших можливостей є тільки у верифікованих учасників спільноти.
* Верифікувати будь-якого неверифікованого учасника може будь-який верифікований.
* Якщо ви вже верифіковані - верифікувати будь-кого можна просто написавши в чат `/verify @нік-того-кого-ви-верифікуєте`, наприклад `/verify @DiRaven` і відправивши повідомлення.
*** Якщо бажаєте бути верифіковані - просто напишіть про своє бажання будь-де і вас верифікують інші учасники спільноти.**
Діліться верифікацією сміливо, але дивіться щоб не верифікувати кацапів ненароком.""",  # noqa
    },
}
