...
var (
	authUserUserPermissionDBTypes = map[string]string{`ID`: `integer`, `PermissionID`: `integer`, `UserID`: `integer`}
	_                             = bytes.MinRead
)
...
func testAuthUserUserPermissionsUpdate(t *testing.T) {
	...
	if len(authUserUserPermissionColumns) == len(authUserUserPermissionPrimaryKeyColumns) {
...
func testAuthUserUserPermissionsSliceUpdateAll(t *testing.T) {
	...
	var fields []string
	if strmangle.StringSliceMatch(authUserUserPermissionColumns, authUserUserPermissionPrimaryKeyColumns) {
		fields = authUserUserPermissionColumns
	} else {
