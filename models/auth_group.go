...
func (authGroupL) LoadGroupAuthGroupPermissions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAuthGroup interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`auth_group_permissions`), qm.WhereIn(`group_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (authGroupL) LoadGroupAuthUserGroups(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAuthGroup interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`auth_user_groups`), qm.WhereIn(`group_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o AuthGroupSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no AuthGroup slice provided for delete all")
	}
