...
const items = [
  ...
  {
    name: 'russians',
    description: 'Чому росіян варто називати росіянами?',
    embed: new EmbedBuilder().setTitle('Росіяни').setDescription(
      `
      Навішуючи ярлики типу "орки" чи "свинособаки" ми свідомо дистанціюємо ті звірства що вони роблять від них самих. Відокремлюємо росіян від їх злочинів, приписуючи це міфічним "оркам". В своїй свідомости та в свідомості суспільств за кордоном. Це як підміняти війну "СВО". Не варто. Цим займаються реальні люди, громадяни росії, себто росіяни. Так, це звучить некомфортно в порівнянні з "орками", але тут краще дивитися правді у вічі і називати речі своїми іменами.
      `,
    ),
  },
  {
    name: 'russian_spoiler',
    description:
      'Чому весь російськомовний контент варто заганяти під спойлер?',
    embed: new EmbedBuilder().setTitle('Русня під спойлером').setDescription(
      `
      Мова - це, в тому числі, зброя. Зброя потужна. Така, що нищить в тилу без всяких ракет та артилерії. Російську мову використовують проти нас відповідно. Там де є російська, себто в російськомовному інфопросторі - шанс натрапити на наративи вигідні РФ значно вищий. Чим більше ми послуговуємося російською - говоримо, читаємо, дивимось, ділимось - тим вразливіші ми для цієї зброі як нація. Сьогодні смішний відосик російською, завтра стаття, післязавтра аналітика, а кілька років - російські новини. Повзуча культурна окупація відбувається не перше десятиліття. Озирніться навколо. Навіщо спрощувати ворогу його задачу?
      `,
    ),
  },
];
