...
const items = [
  {
    ...
    embed: new MessageEmbed()
      ...
      .setDescription(
        ...
        Купа ігор доступні українською завдяки нашим перекладачам-волонтерам, які на то витрачають купу власного часу. Один із найбільших таких проектів - Kingdom Come: Deliverance. Такі ініціативи варто підтримувати. І найкраща підтримка - грати українською. Зіграйте, не пошкодуєте!
  ...
  },
  {
    ...
    embed: new MessageEmbed()
      .setTitle('СВЦ, або Синдром Великого Цабе:')
      .setDescription(
        `
        ...
        **Ускладнення:**  Гостра форма має тенденцію до переходу в хронічну з плином часу, що в свою чергу може призвести до егоцентризму та нарцисизму. Наявний егоцентризм та/або нарцисизм ускладнює перебіг синдрому та прискорює перехід в хронічну стадію.
