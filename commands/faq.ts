...
const items = [
  {
    ...
    embed: new MessageEmbed()
      ...
      .setDescription(
        ...
        Регіональний поділ аудиторії відбувається в тому числі за мовою: часом, доходить до того що деякі ігри Ubisoft та EA певний час для України були недоступні англійською. Наприклад, Lost Ark та деякі інші ММО де нас по факту насильно загнали в ру регіон.

        Купа ігор доступні українською завдяки нашим перекладачам-волонтерам, які на то витрачають купу власного часу. Один з найбільших таких проектів - Kingdom Come: Deliverance. Такі ініціативи варто підтримувати. І найкраща підтримка - грати українською. Зіграйте, не пошкодуєте!
  ...
  },
  {
    ...
    embed: new MessageEmbed()
      ...
      .setDescription(
        ...
        Тому сентенції накшталт "ігри поза політикою" чи "спорт поза політикою" щонайменше неправдиві. Щонайбільше - небезпечні. Люди що позиціонують себе "поза політикою" свідомо відмовляються від відповідальності за власне життя і майбутнє, віддаючи його в руки тих хто "в політиці". Вибір за вас зробить хтось інший, а з наслідками цього вибору доведеться жити вам.
