...
func testAuthGroupToManyGroupAuthGroupPermissions(t *testing.T) {
	...
	authGroupPermission, err := a.GroupAuthGroupPermissions().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
...
func testAuthGroupToManyGroupAuthUserGroups(t *testing.T) {
	...
	authUserGroup, err := a.GroupAuthUserGroups().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
...
func testAuthGroupsUpdate(t *testing.T) {
	...
	if len(authGroupColumns) == len(authGroupPrimaryKeyColumns) {
...
func testAuthGroupsSliceUpdateAll(t *testing.T) {
	...
	var fields []string
	if strmangle.StringSliceMatch(authGroupColumns, authGroupPrimaryKeyColumns) {
		fields = authGroupColumns
	} else {
