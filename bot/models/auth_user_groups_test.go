...
var (
	authUserGroupDBTypes = map[string]string{`GroupID`: `integer`, `ID`: `integer`, `UserID`: `integer`}
	_                    = bytes.MinRead
)
...
func testAuthUserGroupsUpdate(t *testing.T) {
	...
	if len(authUserGroupColumns) == len(authUserGroupPrimaryKeyColumns) {
...
func testAuthUserGroupsSliceUpdateAll(t *testing.T) {
	...
	var fields []string
	if strmangle.StringSliceMatch(authUserGroupColumns, authUserGroupPrimaryKeyColumns) {
		fields = authUserGroupColumns
	} else {
