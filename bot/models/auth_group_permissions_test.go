...
var (
	authGroupPermissionDBTypes = map[string]string{`GroupID`: `integer`, `ID`: `integer`, `PermissionID`: `integer`}
	_                          = bytes.MinRead
)
...
func testAuthGroupPermissionsUpdate(t *testing.T) {
	...
	if len(authGroupPermissionColumns) == len(authGroupPermissionPrimaryKeyColumns) {
...
func testAuthGroupPermissionsSliceUpdateAll(t *testing.T) {
	...
	var fields []string
	if strmangle.StringSliceMatch(authGroupPermissionColumns, authGroupPermissionPrimaryKeyColumns) {
		fields = authGroupPermissionColumns
	} else {
