...
var (
	authUserColumns               = []string{"id", "password", "last_login", "is_superuser", "username", "first_name", "last_name", "email", "is_staff", "is_active", "date_joined"}
...
func (authUserL) LoadUserAuthUserGroups(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAuthUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`auth_user_groups`), qm.WhereIn(`user_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (authUserL) LoadUserAuthUserUserPermissions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAuthUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`auth_user_user_permissions`), qm.WhereIn(`user_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o AuthUserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no AuthUser slice provided for delete all")
	}
